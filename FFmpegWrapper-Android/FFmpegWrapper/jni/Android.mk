...
LOCAL_SRC_FILES:= ../libs/$(TARGET_ARCH)/libx264-152.so
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/include
include $(PREBUILT_SHARED_LIBRARY)
...
LOCAL_SHARED_LIBRARIES := libavformat libavcodec libswscale libavutil libx264
LOCAL_C_INCLUDES += $(LOCAL_PATH)/include
LOCAL_SRC_FILES := FFmpegWrapper.c dash_segmenter.c
