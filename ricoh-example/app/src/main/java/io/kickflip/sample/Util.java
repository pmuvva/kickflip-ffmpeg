...
public class Util {
    ...
    public static SessionConfig create480pSessionConfig(String outputPath) {
    ...
    public static SessionConfig create1080pSessionConfig(String outputPath) {
        HashMap<String, String> extraData = new HashMap<>();
        extraData.put("key", "value");
    ...
    public static SessionConfig create240pSessionConfig(String outputPath) {
        HashMap<String, String> extraData = new HashMap<>();
        extraData.put("key", "value");
