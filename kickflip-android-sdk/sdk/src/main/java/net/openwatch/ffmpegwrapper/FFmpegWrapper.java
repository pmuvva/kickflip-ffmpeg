...
public class FFmpegWrapper {
    ...
    public native void prepareAdextraData(ByteBuffer jData,int jSize);
    public native void writeAVPacketFromEncodedData(ByteBuffer jData, int jIsVideo, int jOffset, int jSize, int jFlags, long jPts,int jKey);
    ...
    static public class AVOptions{
        ...
        public int hlsSegmentDurationSec = 4;
