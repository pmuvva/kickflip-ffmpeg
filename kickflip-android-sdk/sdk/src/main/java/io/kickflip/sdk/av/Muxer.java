...
public abstract class Muxer {
    ...
    public static enum FORMAT { MPEG4, HLS, FMPEG4 }
    ...
    protected long mFirstPtsAudio;
    protected long mFirstPtsVideo;
    protected long mLastPts[];
    protected boolean videoSent=false;
...
//        }
        if(trackIndex == 0){
            if(mFirstPtsVideo==0){
                mFirstPtsVideo = absPts;
                videoSent = true;
                return 0;
            }
            return getSafePts(absPts - mFirstPtsVideo, trackIndex);
        }
        else if(trackIndex == 1){
            if(mFirstPtsVideo==0)
                return 0;
            if(mFirstPtsAudio==0){
                mFirstPtsAudio = absPts;
                return 0;
            }
            return getSafePts(absPts - mFirstPtsAudio, trackIndex);
        }else{
            Log.i(TAG,"Wrong index PTS value");
            return 0;
        }
