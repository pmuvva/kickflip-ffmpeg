    ...
    public static class Builder {
        ...
        public Builder(String outputLocation) {
            ...
            if (outputLocation.contains(".m3u8")) {
                mMuxer = FFmpegMuxer.create(createRecordingPath(outputLocation), Muxer.FORMAT.HLS, mHlsSegmentDuration);
            ...
            } else if (outputLocation.contains(".fmp4")) {
                mMuxer = FFmpegMuxer.create(createRecordingPath(outputLocation), Muxer.FORMAT.FMPEG4, mHlsSegmentDuration);
            } else
